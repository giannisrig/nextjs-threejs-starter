...
const Scene1 = () => {
  ...
  return (
    <Scene objectsDeps={1} cameraPosition={new Vector3(80, 11, 86)} targetPosition={new Vector3(-43, 14, -31)}>
      <Suspense>
        <GLTFModel url={"/models/website-scene-1.glb"} name={"Scene 1 Object"} modelPosition={[0, 0, 0]} modelScale={6} />
      </Suspense>
    </Scene>
  );
};
