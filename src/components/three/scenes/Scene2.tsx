...
const Scene2 = () => {
  ...
  return (
    <Scene objectsDeps={1} cameraPosition={new Vector3(0, 11, 9)} targetPosition={new Vector3(48, 4, 294)}>
      <Suspense>
        <GLTFModel url={"/models/NextJSLogo.glb"} name={"Scene 2"} modelPosition={[48, 0, 300]} modelScale={20} />
